...
const Footer = () => {
  ...
  return (
    <>
      <footer className=" w-full bg-gray-50 dark:bg-gray-900 py-6 dark:text-gary-100 bottom-0 left-0 mb-0">
        <div className="container mx-auto max-w-screen-xl px-6 md:px-6 py-6 flex flex-col md:flex-row justify-between">
          <div className="w-full md:w-1/3 mb-4">
            <h2 className="text-xl sm:text-2xl mb-4">
              via ROMA non solo pizza
            </h2>
            <p className="mb-4 text-gray-500 text-sm font-hairline">
              Via Roma | Non Solo Pizza nasce dalla passione per la pizza
              coltivata da un sogno alla realizzazione
            </p>
          </div>
