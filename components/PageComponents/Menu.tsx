...
function Menu({menu, loading}: {menu: MenuProps, loading: boolean }): JSX.Element {
        ...
        <section className='px-2 sm:px-0'>
          ...
          {loading ? (
            ...
            <div
              ...
              className={
                selectedMain
                  ? 'block sm:w-3/5   text-left mx-auto p-2 mb-4 overflow-hidden shadow-2xl'
                  : 'hidden'
              }>
          ...
          {loading ? (
            ...
            <div
              ...
              className={
                selectedPizza
                  ? 'block container md:w-full mx-auto p-2 mb-4 overflow-hidden shadow-2xl'
                  : 'hidden'
              }>
              ...
              <div className='p-2'>
                ...
                <p className='text-gray-900 font-light text-base sm:text-xl mb-2  text-left'>
                  A lato degli ingredienti sono riportati i codici degli
          ...
          {loading ? (
            ...
            <div
              ...
              className={
                selectedDesserts
                  ? 'block w-11/12 md:w-3/5   text-left mx-auto p-2 mb-4 overflow-hidden shadow-2xl'
                  : 'hidden'
              }>
          ...
          {loading ? (
            ...
            <div
              ...
              className={
                selectedDrinks
                  ? 'block container-md  md:w-3/5   p-2 mx-auto mb-4 overflow-hidden shadow-2xl'
                  : 'hidden'
              }>
