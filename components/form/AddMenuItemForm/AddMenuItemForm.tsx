...
interface IFormProps {
  ...
  errors: ErrorProps;
  ingredientsFields?: FieldArrayWithId<Partial<IFormData>, "types", "id">[];
  ingredientsRemove?: UseFieldArrayRemove;
  ingredientsAppend?: UseFieldArrayAppend<IFormData, never>;
  typesField?: FieldArrayWithId<Partial<IFormData>, "types", "id">[];
  typesRemove?: UseFieldArrayRemove;
  typesAppend?: UseFieldArrayAppend<IFormData, never>;
